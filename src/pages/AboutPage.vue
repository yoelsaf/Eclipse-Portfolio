<template>
    <div class="about">
        ...
        <section class="about-text">
            <p>
                I'm Creative disigner in web App and UI/UX Designer from Winnipeg,
                Canada working in web development and print media. I enjoy turning
        ...
        <section class="service">
            <h3 class="h3 service-title">My Services</h3>
                ...
                <li class="testimonials-item">
                    <div class="content-card" data-testimonials-item>
                        ...
                        <div class="testimonials-text" data-testimonials-text>
                            <p>
                                Yoel was hired to create a corporate identity. We were
                                very pleased with the work done. he has a lot of
